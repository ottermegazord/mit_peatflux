...
SWITCH_OPEN = 29
SWITCH_CLOSE = 22 
OPEN_chan_list = [31, 33, 35, 37] # chan_list = [S3, S2, S1, S0]
CLOSE_chan_list = [32, 36, 38, 40] # chan_list = [S3, S2, S1, S0]

""" Time Interval """

INTERVAL = 0.25 # Pulse Interval 
SWITCHING_INTERVAL = 2 # amount of time valve will stay open
CYCLE_INTERVAL = 600 # buffer between end and start of cycles, in seconds
